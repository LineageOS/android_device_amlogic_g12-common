...
public class KeyHandler implements DeviceKeyHandler {
    ...
    // Button key codes
    private static final int DOPINDER_KEY_YOUTUBE = 140;
    private static final int DOPINDER_KEY_NETFLIX = 141;
    private static final int DOPINDER_KEY_DISNEY = 137;
    private static final int DOPINDER_KEY_HBOMAX = 138;
    private static final int DOPINDER_KEY_TV_SETTINGS = 176;

    private static final int SABRINA_KEY_YOUTUBE = 189;
    private static final int SABRINA_KEY_NETFLIX = 190;

    private static final int WADE_KEY_GPLAY = 142;
    private static final int WADE_KEY_NETFLIX = 141;
    private static final int WADE_KEY_YOUTUBE = 140;
    ...
    private void launchActivity(String packageName) {
        Intent launchIntent;
        if (packageName.equals(PACKAGE_TV_SETTINGS)) {
